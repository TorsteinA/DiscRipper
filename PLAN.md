...
- [ ] Make sure disabled buttons show their "disabledness" in the UI.
  - Right now they just don't run their function, but still have ie hover effects and look the same.
